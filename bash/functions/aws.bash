...
# Bad idea as sub process can steal env variables, so we need to use /> aws-vault exec profilename  -- command
# to limit exposure to anything other than the intended process
